...
import { Collapse, ErrorMessage, DatetimeRoot, DatetimeRangeRoot, TimerRoot, MonthRoot, YearRoot } from "../common";
...
const Datetime = ({ item }: Props) => {
    ...
    if (!general?.type) return <p className="text-sm text-red-600 font-light col-span-12">Please select a datetime type</p>;
