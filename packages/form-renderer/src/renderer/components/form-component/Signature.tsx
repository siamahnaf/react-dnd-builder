...
import { Collapse, ErrorMessage, SignatureRoot } from "../common";
...
const Signature = ({ item }: Props) => {
    ...
    const { isVisible, isRequired, isReadOnly } = useConditionalProps({
        ...
        base: { isVisible: general?.isVisible, isReadOnly: false, isRequired: advance?.isRequired }
    })
