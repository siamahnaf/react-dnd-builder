            ...
            >
                <style jsx>{`
                    ...
                    .heading-type {
                        ...
                        text-align: ${item.content.alignment[device.value]};
                        color: ${item.style.text_color};
                        font-family: ${item.style.typography.family};
                        font-size: ${item.style.typography.size[device.value].value}${item.style.typography.size[device.value].unit} !important;
                ...
                <div
                    className={`relative heading-container ${item.advance.layout.css_class}`}
                ...
                >
                    ...
                    <div className="heading-type">
                        <ContentEditable
                            ...
                            disabled={false}
                            onChange={(e) => updateHeading(headResp("content", { content: e.target.value }))}
                            tagName={item.content.html_tag || "h4"}
                            className="font-semibold focus:outline-none cursor-default focus:cursor-text"
                        />
                    </div>
                </div>
            </div>
