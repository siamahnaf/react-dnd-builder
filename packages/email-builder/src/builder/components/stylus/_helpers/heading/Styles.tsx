...
//Components
import { ColorPicker, OptionGroup, SelectBox, SliderInput } from "../../../../components/common/control";
//Store
                ...
                {active === "title" &&
                    <div className="px-3.5 mb-6 space-y-5">
                        <ColorPicker
                            ...
                            onChange={(e) => updateHeading(headResp("style", { text_color: e }))}
                        />
                        <OptionGroup
                            label="Typography"
                        >
                            <SelectBox
                                ...
                                onChange={(e) => updateHeading(headResp("style", "typography", { family: e }))}
                                options={[
                            ...
                            <SliderInput
                                ...
                                onChange={(e) => updateHeading(headResp("style", "typography", "size", {
                                    [device.value]: {
                                        value: e
                                    }
                                }))}
                                unit={target?.style.typography.size[device.value].unit}
                                onUnitChange={(e) => updateHeading(headResp("style", "typography", "size", {
                                    [device.value]: {
                                        unit: e
                                    }
                                }))}
                            ...
                            <SelectBox
                                ...
                                onChange={(e) => updateHeading(headResp("style", "typography", { weight: e }))}
                                options={[
                            ...
                            <SelectBox
                                ...
                                onChange={(e) => updateHeading(headResp("style", "typography", { transform: e }))}
                                options={[
                                    { value: "", label: "Default" },
                            ...
                            <SelectBox
                                ...
                                onChange={(e) => updateHeading(headResp("style", "typography", { style: e }))}
                                options={[
                                    { value: "", label: "Default" },
                            ...
                            <SelectBox
                                ...
                                onChange={(e) => updateHeading(headResp("style", "typography", { decoration: e }))}
                                options={[
                                    { value: "", label: "Default" },
                            ...
                            <SliderInput
                                ...
                                onChange={(e) => updateHeading(headResp("style", "typography", "line_height", {
                                    [device.value]: {
                                        value: e
                                    }
                                }))}
                                unit={target?.style.typography.line_height[device.value].unit}
                                onUnitChange={(e) => updateHeading(headResp("style", "typography", "line_height", {
                                    [device.value]: {
                                        unit: e
                                    }
                                }))}
                            ...
                            <SliderInput
                                ...
                                onChange={(e) => updateHeading(headResp("style", "typography", "letter_spacing", {
                                    [device.value]: {
                                        value: e
                                    }
                                }))}
                                unit={target?.style.typography.letter_spacing[device.value].unit}
                                onUnitChange={(e) => updateHeading(headResp("style", "typography", "letter_spacing", {
                                    [device.value]: {
                                        unit: e
                                    }
                                }))}
                            ...
                            <SliderInput
                                ...
                                onChange={(e) => updateHeading(headResp("style", "typography", "word_spacing", {
                                    [device.value]: {
                                        value: e
                                    }
                                }))}
                                unit={target?.style.typography.word_spacing[device.value].unit}
                                onUnitChange={(e) => updateHeading(headResp("style", "typography", "word_spacing", {
                                    [device.value]: {
                                        unit: e
                                    }
                                }))}
