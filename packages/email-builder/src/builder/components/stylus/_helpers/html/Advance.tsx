                ...
                {active === "layout" &&
                    <div className="px-3.5 mb-6 mt-1.5">
                        <GroupInput
                            ...
                            onChange={(e) => {
                                if (e.direction === "all") {
                                    updateHtml(htmlResp("advance", "layout", "margin", {
                                        [device.value]: {
                                            top: e.value,
                                            left: e.value,
                                            right: e.value,
                            ...
                            onUnitChange={(e) => updateHtml(htmlResp("advance", "layout", "margin", {
                                [device.value]: {
                                    unit: e
                                }
                            }))}
                        ...
                        <GroupInput
                            ...
                            onChange={(e) => {
                                if (e.direction === "all") {
                                    updateHtml(htmlResp("advance", "layout", "padding", {
                                        [device.value]: {
                                            top: e.value,
                                            left: e.value,
                                            right: e.value,
                            ...
                            onUnitChange={(e) => updateHtml(htmlResp("advance", "layout", "padding", {
                                [device.value]: {
                                    unit: e
                                }
                            }))}
                        ...
                        <InputBox
                            ...
                            onChange={(e) => updateHtml(htmlResp("advance", "layout", { css_id: e }))}
                        />
                        <InputBox
                            label="CSS Classes"
                            value={target?.advance.layout.css_class || ""}
                            onChange={(e) => updateHtml(htmlResp("advance", "layout", { css_class: e }))}
                        />
                    </div>
                }
            </div>
                ...
                {active === "background" &&
                    <div className="px-3.5 mt-4">
                        <BackgroundOption
                            ...
                            onTypeChange={(e) => updateHtml(htmlResp("advance", "background", { background_type: e }))}
                            colorValue={target?.advance.background.color || ""}
                            onColorChange={(e) => updateHtml(htmlResp("advance", "background", { color: e }))}
                            imageValue={{
                            ...
                            onImageChange={(e) => updateHtml(htmlResp("advance", "background", "image", {
                                url: e.url,
                                props: {
                                    alt_text: e.alt,
                                    caption: e.caption
                ...
                {active === "border" &&
                    <div className="px-3.5 mt-2">
                        <SelectBox
                            ...
                            onChange={(e) => updateHtml(htmlResp("advance", "border", { border_type: e }))}
                            options={[
                                { value: "", label: "Default" },
                        ...
                        <GroupInput
                            ...
                            onChange={(e) => {
                                if (e.direction === "all") {
                                    updateHtml(htmlResp("advance", "border", "border_width", {
                                        [device.value]: {
                                            top: e.value,
                                            left: e.value,
                                            right: e.value,
                            ...
                            onUnitChange={(e) => updateHtml(htmlResp("advance", "border", "border_width", {
                                [device.value]: {
                                    unit: e
                                }
                            }))}
                        ...
                        <ColorPicker
                            ...
                            onChange={(e) => updateHtml(htmlResp("advance", "border", { border_color: e }))}
                        />
                        <GroupInput
                            label="Border Radius"
                            values={[
                            ...
                            onChange={(e) => {
                                if (e.direction === "all") {
                                    updateHtml(htmlResp("advance", "border", "border_radius", {
                                        [device.value]: {
                                            top: e.value,
                                            left: e.value,
                                            right: e.value,
                            ...
                            onUnitChange={(e) => updateHtml(htmlResp("advance", "border", "border_radius", {
                                [device.value]: {
                                    unit: e
                                }
                            }))}
                ...
                {active === "responsive" &&
                    <div className="px-3.5 mt-4 mb-5">
                        <Switcher
                            ...
                            onChange={(e) => updateHtml(htmlResp("advance", "responsive", { desktop: e }))}
                        />
                        <Switcher
                            label="Hide On Tablet"
                            value={target?.advance.responsive.tablet}
                            onChange={(e) => updateHtml(htmlResp("advance", "responsive", { tablet: e }))}
                        />
                        <Switcher
                            label="Hide On Mobile"
                            value={target?.advance.responsive.mobile}
                            onChange={(e) => updateHtml(htmlResp("advance", "responsive", { mobile: e }))}
                        />
                    </div>
                }
            </div>
                ...
                {active === "custom_css" &&
                    <div className="px-3.5 mt-4">
                        <CodeEditor
                            ...
                            onChange={(e) => updateHtml(htmlResp("advance", { custom_css: e }))}
                        />
                    </div>
                }
            </div>
